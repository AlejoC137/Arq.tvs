// Force rebuild 2025-12-15 01:36
...
function App() {
  ...
  return (
    ...
    <div className="min-h-screen bg-gray-50">
      {/* Sidebar */}
      <div className="fixed inset-y-0 left-0 w-64 bg-white shadow-lg flex flex-col z-30">
          ...
          <div className="p-4 border-t bg-white flex-shrink-0">
            ...
            <div className="space-y-2 max-h-48 overflow-y-auto custom-scrollbar">
              {notifications.map((notification) => (
                <div
                  key={notification.id}
                  className={`p-3 rounded-lg text-sm ${notification.type === 'error'
