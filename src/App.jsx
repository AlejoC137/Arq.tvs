      ...
      <div className="w-64 bg-white shadow-lg flex flex-col">
        ...
        <div className="p-4 border-t">
          <div className="flex space-x-2">
            ...
            <label
              className="flex-1 flex items-center justify-center space-x-2 px-3 py-2 bg-blue-100 text-blue-700 rounded-lg hover:bg-blue-200 transition-colors cursor-pointer"
