...
// <--- CAMBIO 1: 'DataRow' se movió fuera del componente 'Materiales' ---
// Resuelve el problema de pérdida de foco en el input.
...
  
  return (
  	// Tu código original no tenía la columna Estatus, así que la quito
...
  // --- Lógica de edición ---
  
  // <--- CAMBIO 2: 'onCellChange' envuelto en 'useCallback' ---
  // Resuelve el problema de pérdida de foco en el input.
...
  // Hook y componente ColumnPicker
...
  						{/* Cabecera (sin la columna Estatus que yo había agregado) */}
...
  										>
  											{/* <--- CAMBIO 3: Corregido el colSpan (sin el +1) --- */}
...
  										{/* <--- CAMBIO 4: Se pasan las props a 'DataRow' --- */ }
...
  							{/* <--- CAMBIO 5: Se pasan las props a 'DataRow' --- */ }
...
  								<tr>
  									{/* <--- CAMBIO 6: Corregido el colSpan (sin el +1) --- */}
